...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
      ...
      #First - I need to select the titles of all projects
      #Second - I need to somehow target the amount over goal of all projects that have met there goals
      #project 2 - "my book on sql" hit it's goal exactly on, 20/20
      #project 6 - "next inna" went over goal, 342/200 = 142
      # sum pledges amount than subtract funding goal, use AS to label
      #Use having
